      ...
      <div style='border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;'>
					...
					if (in_array(strtolower($file_ext), $allowed_types)) {
						...
						if (file_exists($filepath)) {
							...
							if (move_uploaded_file($file_tmpname, $filepath)) {
								$sql = "INSERT INTO  banner_table (path,addedby) VALUES ('" . $linktodata . "','" . $email . "')";
        ...
        <p><b>{$file_name}</b> successfully uploaded.</p>";
							...
							if (move_uploaded_file($file_tmpname, $filepath)) {
								...
								$result = mysqli_query($con, $sql);
								echo "{$file_name} successfully uploaded 2<br/>";
							} else {
								echo "Error uploading {$file_name} <br />";
							}
						}
...
sleep(2);
echo "<script>window.location.href='../../pjimcms/admin/edit/banner.php';</script>";
