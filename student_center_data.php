...
include('./student_aurthorization.php');
?>
                ...
                <ul class="pl-0 list-unstyled mt-5">
                    ...
                    <li id="rules_regulation">
                        <a href="#rules_regulation">
                            <div> <img src="images/sitar.png" alt="sitar" class="img-fluid col-md-6" style="margin-top: -43px;"></div>
                            <div>Rules & Regulations</div>
                        </a>
                    </li>
                    <li id="mewati_gurukul">
                        <a href="#mewati_gurukul">
                            <div> <img src="images/tabla.png" alt="tabla" class="img-fluid col-md-7"></div>
            ...
            <div class="tabs_content tabs mt-5 mb-5">
                ...
                <div id="being_a_student" class="being_a_student1 active mt-5 mb-5">
                    <div>
                        ...
                        <div class="tab_titl">
                            ...
                            <p class="font-weight-bold">On behalf of the <br>
                ...
                <div id="rules_regulation" class="rules_regulation1 content_tabs mt-5 mb-5">
                    <div>
                        ...
                        <div class="tab_titl">
                            <h5 class="font-weight-bold">The Institution</h5>
                            ...
                            <h6 class="mt-2 pt-4 mb-3 font-weight-bold">Gurukul’s expanded locations:</h6>
                            ...
                            <h5 class="mt-5 mb-3 font-weight-bold">Admission</h5>
                            ...
                            <h6 class="mt-4 mb-3">Admission</h6>
                            <p>
                            <ul class="pl-2 mt-4">
                            ...
                            <h5 class="mt-3 mb-3 font-weight-bold">Responsibilities and Commitments</h5>
                            ...
                            <div>
                                <h5 class="mt-5 mb-3 font-weight-bold ">Mode of Payment:</h5>
                                <div class="tab_titl">
                ...
                <div id="mewati_gurukul" class="mewati_gurukul1 content_tabs mt-5 mb-5">
                    <div>
                        <h4 class="mt-3 font-weight-bold"><u>Mewati Gurukul Sanskaar (The Code of Conduct)</u></h4>
                        <div class="tab_titl">
                        ...
                        <div class="container tab_titl">
                            <div class="mt-3">
                                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                    ...
                                    <table>
                                        <tr>
                                            <td><input type="hidden" name="on0" value="Absence Fee with Late Fee">
                                                <h4 class="mt-3 mb-2">Absence Fee with Late Fee</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                    ...
                                    <table>
                                        <tr>
                                            <td><input type="hidden" name="on0" value="Shibir packages">Shibir packages</td>
                                        </tr>
                                        <tr>
                                            <td><select name="os0" class="form-control">
